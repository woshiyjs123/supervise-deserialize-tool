...
public class AssetContractInfo {
     ...
     * 逾期日期
     */
    @Column(order = 25, comment = "逾期日期", length = 8, canBeEmpty = false)
     ...
     */
    @Column(order = 36, comment = "贷款投向行业", length = 5, canBeEmpty = false)
     ...
     */
    @Column(order = 46, comment = "贷款投向地区", length = 6, canBeEmpty = false)
